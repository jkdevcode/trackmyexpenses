...
This module exposes runtime health information for the backend so local environments, CI, and deployment infrastructure can verify readiness.
...
- Useful for deployment checks, operational dashboards, and debugging local startup issues.
